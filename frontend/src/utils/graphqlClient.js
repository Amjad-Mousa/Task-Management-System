/**
 * @file graphqlClient.js - GraphQL client utility for making API requests
 * @module src/utils/graphqlClient
 *
 * Uses the fetch API to send GraphQL queries and mutations to the backend
 */
