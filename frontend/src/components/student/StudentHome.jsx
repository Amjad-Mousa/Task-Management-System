/**
 * @file StudentHome.jsx - Student dashboard home component
 * @module components/student/StudentHome
 */
 ...
 * Displays statistics, projects, tasks, and provides interactive filtering
 *
 * @returns {React.ReactElement} Rendered StudentHome component
 */
const StudentHome = () => {
  ...
  /**
   * Fetches tasks assigned to the current student with caching
  ...
  /**
   * Fetches projects assigned to the current student with caching
   * @param {boolean} forceRefresh - Whether to bypass cache and force a refresh
  ...
  /**
   * Loads all student data with refresh capability
   * Fetches tasks and projects in parallel for better performance
   *
   * @param {boolean} forceRefresh - Whether to bypass cache and force a refresh
  ...
  /**
   * Determines if a task has an upcoming deadline within the next 7 days
   * @param {Object} task - The task to check
   * @param {Date|string|number} task.dueDate - The task's due date
   * @param {string} task.status - The task's status
   * @returns {boolean} True if the task has an upcoming deadline
   */
  ...
  /**
   * Handles stat card click to filter dashboard content
   * @param {string} statTitle - The title of the clicked stat card
   */
