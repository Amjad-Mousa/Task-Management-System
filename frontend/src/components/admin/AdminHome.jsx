/**
 * @file AdminHome.jsx - Admin dashboard home component
 * @module components/admin/AdminHome
 */
...
/**
 * AdminHome component for the admin dashboard
 * Displays statistics, quick actions, task status overview, and recent activities
 *
 * @returns {React.ReactElement} Rendered AdminHome component
 */
const AdminHome = () => {
  ...
  /**
   * Fetches projects from API with optimized caching
  ...
  /**
   * Fetches students from API with optimized caching
  ...
  /**
   * Fetches recent tasks with shorter cache time
  ...
  /**
   * Loads all dashboard data with optimized error handling and caching
   */
  useEffect(() => {
  ...
  /**
   * Handles stat card click to toggle selection
