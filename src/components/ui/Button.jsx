...
const Button = ({ 
  ...
  // Base classes
  const baseClasses = 'rounded font-medium transition-all duration-200 btn-hover-effect';
  ...
  const variantClasses = {
    ...
    outline: 'bg-transparent border border-gray-300 hover:bg-gray-100 text-gray-800 dark:border-gray-600 dark:hover:bg-gray-700 dark:text-white',
  };
